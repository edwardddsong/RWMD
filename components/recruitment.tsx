    ...
    <section className="relative">
        ...
        <div className="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-10 max-w-xs mx-auto md:max-w-none -m-5">
            ...
            <div className="text-center p-5">
              ...
              <div className="font-bold text-slate-100 mb-1">热情与热爱</div>
              <p className="text-sm text-slate-400">
                您对任何形式的金融销售行业业充满热情，内心是一位天生的挑战者{" "}
              </p>
            </div>
            {/* Block #2 */}
            <div className="text-center p-5">
              ...
              <div className="font-bold text-slate-100 mb-1">创造与想象</div>
              <p className="text-sm text-slate-400">
                您对任何形式的金融市场推广行业充满热情，内心是一位天生的创造者
              </p>
            </div>
            {/* Block #3 */}
            <div className="text-center p-5">
              ...
              <div className="font-bold text-slate-100 mb-1">交流与分享</div>
              <p className="text-sm text-slate-400">
                如果您对金融市场有着自己独到的见解，内心是一位天生的分享者
              </p>
            </div>
          </div>
        </div>
      ...
      {/* <div className="relative px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto py-12 md:py-20">
          <h3 className="h3 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-8 md:pb-16">
            Open positions
          </h3>
          <div className="space-y-8">
            {items.map((item, index) => (
              <div key={index}>
                <h4 className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                  {item.area}
                </h4>
