        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              RWMD机构算法交易课程的组成以及您将会学习到的关于算法交易的一切。
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">风险管理</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    学习如何计算风险，确定每笔交易的投入，并将其整合到交易计划中，
                    学习如何固定亏损， 最大化利润
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">基础概念</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    学习订单块，公允价值缺口等算法交易理论为后期打好基础
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">学习交易时间</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    多方面学习交易周期，盯盘最佳时间，流动性最佳时间，为将来的入场模型奠定基础
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    学习交投区间理论，熟悉不同的入场模型。学习模型逻辑以及如何运用到交易中
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">盘面进阶理论</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    深入学习k线的形成，学习市场周期，学习机构操纵原理
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    学会自上而下的盘面分析，如何形成自己的交易系统，如何遵循自己的交易系统
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    每周日北京时间
                    20:30为您带来上周交易拆解，盘面详解以及下周盘面预期和答疑
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">一对一辅导</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    定制化课程内容以及为每一位学员解答所有的疑惑知识点
                  </p>
                </div>
                {/* Feature */}
                {/* <div>
