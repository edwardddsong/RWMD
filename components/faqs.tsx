          ...
          <div className="md:flex md:space-x-12 space-y-8 md:space-y-0">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              ...
              <div className="space-y-2">
                <h4 className="font-semibold">What is RWMD?</h4>
              ...
              <div className="space-y-2">
                <h4 className="font-semibold">
                  What's an affordable alternative to RWMD?
                </h4>
                <p className="text-slate-400">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              ...
              <div className="space-y-2">
                <h4 className="font-semibold">
                  Can I remove the 'Powered by RWMD' branding?
                </h4>
                <p className="text-slate-400">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div className="w-full md:w-1/2 space-y-8">
              ...
              {/* Item */}
              <div className="space-y-2">
                <h4 className="font-semibold">Can I use RWMD for free?</h4>
                <p className="text-slate-400">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Quis enim lobortis scelerisque fermentum.
              ...
              <div className="space-y-2">
                <h4 className="font-semibold">
                  Is RWMD affordable for small businesses?
                </h4>
                <p className="text-slate-400">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
